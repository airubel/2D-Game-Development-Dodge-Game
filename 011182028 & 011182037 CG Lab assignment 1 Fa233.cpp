...
struct Point centerE1 = {100, 162}; //E1 Center
struct Point centerE2 = {22, 162}; //E2 Center
struct Point centerA1 = {70, 60}; //A1 Center
struct Point centerA2 = {130, 70}; //A2 Center
float radiusE1 = 5; //E1 Radius
float radiusE2 = 5; //E2 Radius
float radiusA1 = 4; //A1 Radius
float radiusA2 = 4; //A2 Radius
float velocity = 0.02;
...
int score = 0; //score
int enemy1State = 0; //E state 0,1,2,3
int enemy2State = 0;
